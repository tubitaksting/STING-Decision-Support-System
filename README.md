...
**Patient Card · Intermediate Risk (IR)**
![Patient detail card — IR class](docs/images/ss_tab6_card_ir.png)
...
**Patient Card · High Risk (HR) with Adverse Genetics**
![Patient detail card — HR class](docs/images/ss_tab6_card_hr.png)

</td>
<td width="50%">

**Patient Card · MRD, PI Advisory & Treatment Protocol**
![Patient detail card — MRD and protocol sections](docs/images/ss_tab6_card_detail.png)
